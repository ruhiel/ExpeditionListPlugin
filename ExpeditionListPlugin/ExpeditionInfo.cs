...
namespace ExpeditionListPlugin
{
    public class ExpeditionInfo
    {
        ...
        public static ExpeditionInfo[] _ExpeditionTable = new ExpeditionInfo[]
        {
            ...
            new ExpeditionInfo {Area="北方", EName="航空機輸送作戦", Time="05:00", Lv=15, RequireShipType=new Dictionary<Tuple<string, int>[], Tuple<string, int>[]> { { new Tuple<string, int>[] { Tuple.Create(AIRCRAFTCARRIER, 1), Tuple.Create(DESTROYER, 3) }, null } }, ShipNum=6, Steel=300, Bauxite=100, InstantRepairMaterials=1},
